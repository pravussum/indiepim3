 ...
 * the License.
 */
package com.google.api.services.gdata.xml;
...
import com.google.api.services.gdata.GDataClient;
...
public abstract class GDataXmlClient extends GDataClient {
  ...
  protected final <T> T executePatchRelativeToOriginal(GoogleUrl url, T original, T updated, String etag) throws IOException {
    AtomPatchRelativeToOriginalContent content = new AtomPatchRelativeToOriginalContent(namespaceDictionary, original, updated);
